...
class _UserEditState extends State<UserEdit>
  ...
  Widget build(BuildContext context) {
    var fotoPerfil = this.widget.doc.data['photo'];

    var primeiroNome = _firstName.text = this.widget.doc.data['firstName'];
    var ultimoNome = _lastName.text = this.widget.doc.data['lastName'];
    var email_ = _email.text = this.widget.doc.data['email'];
    var senha = _password.text = this.widget.doc.data['password'];
    ...
    if (_formKey.currentState.validate()) {
      try {
        ...
        await Auth.signUp(email, password).then((uID) {
          Auth.updateUserSettingsDB(new User(
              userId: uID,
              email: email,
              firstName: firstName,
              lastName: lastName,
